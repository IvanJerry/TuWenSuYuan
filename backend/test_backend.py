...
class FAPEvaluator:
    def __init__(self, args):
        """
        完全独立的评估器，只需：
        - model_path: 模型文件完整路径 (如 saved_models/model.pth)
        """
        ...
        self.model_path1 = "/root/project/yun/FAP/output_ep8/few_shot/adv_term-cos_eps-1_alpha-1_train_iter-2_test_iter-100_lambda1-1.5/FAP_vit_b32_ep10_batch4_2ctx_notransform/caltech101_shot16/seed0/MultiModalPromptLearner/epoch_8.pt"
        self.model_path2 = "/root/project/yun/FAP/output_ep8/few_shot/adv_term-cos_eps-1_alpha-1_train_iter-2_test_iter-100_lambda1-1.5/FAP_vit_b32_ep10_batch4_2ctx_notransform/caltech101_shot16/seed0/MultiModalPromptLearner/model.pth.tar-8"
    ...
    def test(self):
        ...
        for batch_idx, batch in enumerate(tqdm(data_loader)):          
            ...
            with torch.no_grad():
                ...
                #mixer = DonutMixer()
                #water_image = mixer.mix(input, key_image) 
